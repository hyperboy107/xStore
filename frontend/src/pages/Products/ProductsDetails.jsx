...
const ProductsDetails = () => {
  ...
  return (
    <>
        <div>
            <Link to='/' className='text-purple-500 font-semibold hover:text-pink-500 ml-[10rem]'>
Go Back
            </Link>
        </div>
        ...
        {isLoading ? (<Loader />) : error ? (
            ...
            <div className="flex flex-wrap relative items-between mt-[2rem] ml-[10rem]">
                <div>
                    ...
                    className='w-full xl:w-[45rem] lg:w-[40rem] md:w-[30rem] sm:w-[20rem] mr-[2rem]' />
                ...
                <div className="flex flex-col justify-between">
                    ...
                    <p className="my-4 xl:w-[35rem] lg:w-[35rem] md:w-[30rem] sm:w-[20rem] text-[#B0B0B0]">{product.description}</p>
                    <p className="text-3xl ny-4 font-extrabold">₹{product.price}</p>
                    ...
                    <div className="flex items-center justify-between w-[20rem]">
                        ...
                        <div className="two">
                            ...
                            <h1 className="flex items-center mb-6">
                                <FaBox className='mr-2 text-white' /> Stock: {" "} {product.countInStock}
                            </h1>
                        </div>
                    </div>
                    ...
                    {product.countInStock > 0 && (
                        <div>
                            <select value={qty} onChange={(e) => setQty(e.target.value)} className='p-2 w-[6rem] rounded-lg text-blue-600'>
