...
import { useGetUsersQuery,useGetUserDetailsQuery,useDeleteUserMutation,useUpdateUserMutation } from '../../redux/api/userApiSlice'
                            ...
                            <tr key={user._id}>
                                ...
                                <td className="px-4 py-2">{editableUserId == user._id ?(
                                    <div className="flex items-center">
                                        ...
                                        <button onClick={() => updateHandler(user._id)} className="ml-2 bg-purple-500 text-white py-2 px-4 rounded-lg">
                                            <FaCheck />
                                        </button>
                                    </div>
                                ): (
