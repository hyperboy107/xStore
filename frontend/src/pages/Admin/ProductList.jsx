...
import {useCreateProductMutation,
    useAllProductsQuery, useCreateReviewMutation, useDeleteProductMutation, useGetNewProductsQuery, useGetProductByIdQuery, useGetProductDetailsQuery, useGetProductsQuery, useGetTopProductsQuery, useUpdateProductMutation, useUploadProductImageMutation
    ...
    <div className="container xl:mx-[9rem] sm:mx-[0]">
        ...
        <AdminMenu />
            <div className="md:w-3/4 p-3">
                <div className="h-12">Add Product</div>
            ...
            <label className="border text-white px-4 block w-full text-center rounded-lg cursor-pointer font-bold py-11">
              ...
              />
                ...
                <div className="p-3">
                    ...
                    <button onClick={handleSubmit} className="py-4 px-10 mt-5 rounded-lg text-lg font-bold bg-pink-500">Submit</button>
                </div>
            </div>
        </div>
    </div>
