...
const Order = () => {
  ...
  return (
    isLoading ? (<Loader />) : error ? (<Message variant='danger'>{error.data.message}</Message>) : (
        <div className='conatiner flex flex-col ml-[10rem] md:flex-row'>
            ...
            <div className="md:w-1/3">
                <div className="mt-2 border-gray-300 pb-4 mb-4">
                    ...
                    <p className="mb-4">
                        <strong className="text-pink-500">Address: </strong> {order.shippingAddress.address}, <br/>
                ...
                <div className='flex justify-between mb-2 bg-[#4f46e5]'>
                    <span>Items: </span>
                ...
                {userInfo && userInfo.isAdmin && order.isPaid && !order.isDelivered && (
                    <div>
                        <button type='button' className='bg-pink-500 hover:text-2xl hover:bg-[#4f46e5] text-white w-full py-2' onClick={deliverHandler}>Mark As Delivered</button>
                    </div>
                )}
            </div>
        </div>
